"""TMA store helper shared by eligible NVIDIA Chunk-GDN kernels."""
...
class CollectiveStoreTma:
    def __init__(self, blk_q: int, d: int, aligned_full_blocks: bool = False):
        self.BLK_Q = blk_q
        self.D = d
    ...
    def partition_sd(
        ...
        mO = cute.domain_offset(
            (
                ...
                work_desc.tok_offset + blk * cutlass.Int32(self.BLK_Q),
            ),
